...
(setq bb2-keywords
	...
	"ASin" "ASyncFade" "ATan" "AbleICR_a" "AbleICR_b" 
	"Abs" "AbsMouse" "Activate" "ActivateSelectedBox" "ActivateString" 
	"ActiveScreen" "ActiveWindow" "AddAppIcon" "AddAppMenu" "AddAppWindow" 
	"AddBox" "AddFirst" "AddICRVector_a" "AddICRVector_b" "AddIDCMP" 
	"AddItem" "AddLast" "Addr" "AdjustChunky" "AllFire" 
	"AllocFill" "AllocMem" "AnalyzeDisk" "AnimLoop" "AppEvent" 
	"AppEventID" "AppEventType" "AppFile" "AppIconEvent" "AppIconFile" 
	"AppIconHit" "AppLock" "AppMenuEvent" "AppMenuFile" "AppMenuHit" 
	"AppMessage" "AppNumFiles" "AppWindowEvent" "AppWindowFile" "Asc" 
	"AsmExit" "Assign" "Assign$" "AttachGTList" "AutoCookie" 
	"Avg" "Avg.l" "Avg.q" "BBlit" "BBlitMode" 
	"BCHG" "BCLR" "BLITZ" "BLibJsr" "BLoad" 
	"BRA" "BSET" "BSave" "BTST" "Bank" 
	"BankLoc" "BankSize" "Bcc" "BeepScreen" "Bin#" 
	"Bin$" "BitMap" "BitMapInput" "BitMapOrigin" "BitMapOutput" 
	"BitMapPoly" "BitMapToWindow" "BitMapWindow" "BitMaptoWindow" "BitPlanesBitMap" 
	"Blit" "BlitColl" "BlitMode" "BlitterDone" "BlitterNasty" 
	"BlitzEvent" "BlitzFont" "BlitzKey" "BlitzKeys" "BlitzQualifier" 
	"BlitzRepeat" "Block" "BlockScroll" "Blue" "BootProg" 
	"BorderPens" "Borders" "Box" "BoxPrint" "BoxPropX" 
	"BoxPropY" "BoxSelected" "BoxShow" "BoxString" "BoxValue" 
	"Boxf" "Buffer" "ButtonGroup" "ButtonId" "CDDoor" 
	"CDFastForward" "CDFirstTrack" "CDFlush" "CDLastTrack" "CDNormalSpeed" 
	"CDNumTracks" "CDPause" "CDPlayTrack" "CDReadTOC" "CDRewind" 
	"CDSpeed" "CDStatus" "CDStop" "CDTrackLength" "CDTrackMins" 
	"CDTrackPlaying" "CDTrackSecs" "CDUpdateInfo" "CDVolume" "CELSE" 
	"CEND" "CERR" "CHDir" "CHK" "CLR" 
	"CMP" "CMPA" "CMPI" "CMPM" "CMPMEM" 
	"CNIF" "CPUCls" "CPlot" "CPoint" "CSIF" 
	"CacheOff" "CachePCF" "CachesOff" "CachesOn" "Call" 
	"Case" "CaseSense" "CatchDosErrs" "Centre$" "ChDir" 
	"ChangeBox" "ChangeDir" "ChangeTrackerMask" "ChangeTrackerVBlank" "CharCount" 
	"CheckAGA" "CheckPrt" "CheckTrackerEvent" "CheckTrackerID" "Checksum" 
	"ChipFree" "Chr$" "ChunkHeader" "ChunkyCLS" "ChunkyConvert" 
	"ChunkyLoc" "ChunkyPlot" "ChunkyPoly" "ChunkyToBitMap" "ChunkyToPlanar" 
	"ChunkyVlin" "Cipher$" "Circle" "Circlef" "ClearBitmap" 
	"ClearList" "ClearRexxMsg" "ClearString" "ClearToolTypes" "ClickButton" 
	"ClickMouse" "ClipBlit" "ClipBlitMode" "CloseCD" "CloseConsole" 
	"CloseDisk" "CloseEd" "CloseFile" "CloseScreen" "CloseSerial" 
	"CloseWindow" "ClrErr" "ClrInt" "Cls" "CludgeBitMap" 
	"CludgeShapes" "CludgeSound" "Col8" "ColSplit" "ColorChunky" 
	"Colour" "ColourRequest" "CommoditiesBase" "CommodityEvent" "ComparePaths" 
	"Con_Base" "CookieMode" "CopLen" "CopLoc" "CopperAGACol" 
	"CopperCommand" "CopperEnd" "CopperInfoBlock" "CopperMove" "CopperReset" 
	"CopperSkip" "CopperWait" "CopyBitMap" "CopyByte" "CopyChunky" 
	"CopyColour" "CopyFile" "CopyLong" "CopyShape" "CopyWord" 
	"Cos" "CrMDecrunch" "CreateArgString" "CreateDisplay" "CreateMsgPort" 
	"CreateRexxMsg" "CurrentDir$" "CursX" "CursY" "Cursor" 
	"CustomChunky" "CustomChunkySize" "CustomColors" "CustomCop" "CustomSprites" 
	"CustomString" "Cvi" "Cvl" "Cvq" "CxAppear" 
	"CxChangeList" "CxDisAppear" "CxDisable" "CxEnable" "CxKill" 
	"CxListChange" "CxUnique" "Cycle" "CyclePalette" "DBCasesense" 
	"DBInit" "DBLoad" "DBSave" "DBactive" "DBadd" 
	"DBaddFirst" "DBaddLast" "DBcc" "DBcurrent" "DBdelete" 
	"DBfind" "DBfindnext" "DBfirst" "DBget" "DBisnext" 
	"DBisprev" "DBkill" "DBlast" "DBlistaddr" "DBmemtype" 
	"DBmodified" "DBnext" "DBpop" "DBprev" "DBpush" 
	"DBrecs" "DBsetkey" "DBsetpos" "DBupdate" "DCB" 
	"DEFTYPE" "DIVS" "DIVU" "D_CheckNMove" "D_CheckNMoveA" 
	"D_CheckNMoveWord" "D_FindStringPtr" "D_FindVolume" "D_GetSR" "D_HexWord" 
	"Data" "Data$" "Date$" "DateFormat" "Days" 
	"Dc" "Dcb" "DeIce" "DeSelectBox" "DecodeILBM" 
	"DecodeMedModule" "DecodeModule" "DecodePalette" "DecodeShapes" "DecodeSound" 
	"Decrypt" "Default" "DefaultIDCMP" "DefaultInput" "DefaultOutput" 
	"DelAppIcon" "DelAppMenu" "DelAppWindow" "DeleteArgString" "DeleteMsgPort" 
	"DeleteRexxMsg" "Deplode" "Depth" "Derez" "DetachGTList" 
	"DeviceName$" "Dim" "Disable" "DisableBox" "DiskBlocks" 
	"DiskBuffer" "DiskCapacity" "DiskErrors" "DiskErrs" "DiskFontBase" 
	"DiskFree" "DiskIO" "DiskMotor" "DiskPlay" "DiskState" 
	"DiskStatus" "DiskType$" "DiskUnit" "DiskUsed" "DiskfontBase" 
	"DispHeight" "Display" "DisplayAdjust" "DisplayBitMap" "DisplayControls" 
	"DisplayDblScan" "DisplayGenlock" "DisplayOff" "DisplayOn" "DisplayPalette" 
	"DisplayRGB" "DisplayRainbow" "DisplayScroll" "DisplaySprite" "DisplayUser" 
	"DoColSplit" "DoColl" "DoFade" "DosBase" "DosBuffLen" 
	"DosError$" "Dos_Base" "DuplicatePalette" "EMouseX" "EMouseY" 
	"EOR" "EORI" "EVEN" "EXG" "EXT" 
	...
	"ItemStackSize" "JAdaptorStatus" "JFire" "JHoriz" "JMP" 
	"JSR" "JVert" "JoYY" "JoyC" "Joyb" 
	"Joyr" "Joyx" "Joyy" "JumpMed" "KeyCode" 
	"KillFile" "KillGreyChunky" "KillItem" "LCase$" "LEA" 
	"LECludgeShapes" "LECompressShapes" "LEInitShape" "LELoadShapes" "LEMaxShapeDepth" 
	"LEMaxShapeHeight" "LEMaxShapeWidth" "LESaveShapes" "LEScanShapes" "LINK" 
	"LSL" "LSR" "LSet$" "Largest" "Largest.l" 
	"Largest.q" "LargestFree" "LastItem" "Left$" "Len" 
	"Length" "Let" "Line" "Lisa" "List" 
	"ListBase" "LoadAnim" "LoadBank" "LoadBitMap" "LoadBlitzFont" 
	"LoadChunky" "LoadFont" "LoadIFF" "LoadMedModule" "LoadModule" 
	"LoadPCF" "LoadPalette" "LoadScreen" "LoadShape" "LoadShapes" 
	"LoadSound" "LoadSprites" "LoadTape" "LoadTrackerModule" "Loc" 
	"Locate" "Lof" "Log" "Log10" "LoopSound" 
	"MButtons" "MOD" "MOVE" "MOVEA" "MOVEM" 
	"MOVEP" "MOVEQ" "MULS" "MULU" "Macro" 
	"MacroKey" "MakeCommodity" "MakeCookie" "MakeDir" "MatchToolValue" 
	"MatchWild" "Max" "MaxLen" "MaxSelect$" "Maximum" 
	"MemFree" "MenuChecked" "MenuColour" "MenuGap" "MenuHit" 
	"MenuItem" "MenuState" "MenuTitle" "Menus" "MenusOff" 
	"MenusOn" "Mid$" "MidHandle" "Min" "Mins" 
	"MixPalette" "Mki$" "Mkl$" "Mkq$" "Module" 
	"ModulePatterns" "ModulePositionJump" "ModuleSampleName" "ModuleToChip" "Months" 
	"MoreEntries" "MotorOff" "MotorOn" "Mouse" "MouseArea" 
	"MouseButton" "MouseEnabled" "MouseWait" "MouseX" "MouseXSpeed" 
	"MouseY" "MouseYSpeed" "MoveFile" "MoveScreen" "NBCD" 
	"NEG" "NEGX" "NEWTYPE" "NOP" "NOT" 
	"NPrint" "NPrintCon" "NTSC" "NameFile" "NewPaletteMode" 
	"NewToolType" "NewZoneTable" "Next" "NextAppFile" "NextBank" 
	"NextFile$" "NextFrame" "NextItem" "NoCli" "NoMoreEntries" 
	"Null" "NumDays" "NumPars" "OR" "ORI" 
	"On" "OpenCD" "OpenConsole" "OpenDisk" "OpenFile" 
	"OpenSerial" "OutText" "OutTextPen" "PCFDepth" "PCFHeight" 
	"PCFInfo" "PCFVersion" "PCFWidth" "PColl" "PEA" 
	"PICreateRequest" "PIEndRequest" "PIUpdateRequest" "PLoad" "PPDecrunch" 
	"PackPBM" "PalAdjust" "PalBlue" "PalGreen" "PalRGB" 
	"PalRed" "Palette" "PaletteInfo" "PaletteRange" "Par$" 
	"ParPath$" "PathLock" "PathPart$" "PauseModule" "Peek" 
	"PeekMax$" "PeekSound" "PeekTo$" "Peeks$" "Peekto$" 
	"PhoneticSpeak" "Pi" "PlanarToChunky" "PlayBack" "PlayMed" 
	"PlayModule" "PlayTracker" "PlayWait" "Plot" "Point" 
	"Pointer" "Poke" "Poly" "Polyf" "Pop" 
	"PopInput" "PopItem" "PopOutput" "PositionMouse" "PositionSuperBitMap" 
	"PositionSuperBitmap" "PrevItem" "Print" "PrintCon" "ProcessChunky" 
	"Processor" "PropGadget" "PrtCommand" "PrtText" "PushItem" 
	"Put" "PutIconObject" "PutReg" "PutSuperBitMap" "QAMIGA" 
	"QAbs" "QAngle" "QBlit" "QBlitMode" "QFrac" 
	"QLimit" "QWrap" "Qualifier" "Queue" "QuickPlay" 
	"Quiet" "QuietTrap" "RESET" "RGB" "RIAnimFrameCount" 
	"RIAnimInit" "RINextAnimFrame" "ROL" "ROR" "ROXL" 
	"ROXR" "RRandomize" "RRnd" "RSet$" "RTASyncPaletteRequest" 
	"RTASyncRequest" "RTCheckASyncPaletteRequest" "RTCheckASyncRequest" "RTE" "RTEZFlagsRequest" 
	"RTEZFontRequest" "RTEZFreePattern" "RTEZGetLong" "RTEZGetLongRange" "RTEZGetString" 
	"RTEZLoadFile" "RTEZMultiLoadFile" "RTEZPaletteRequest" "RTEZPathRequest" "RTEZRNextPathEntry" 
	"RTEZRequest" "RTEZSaveFile" "RTEZScreenModeRequest" "RTEZSetDefaultDirectory" "RTEZSetPattern" 
	"RTEndASyncPaletteRequest" "RTEndASyncRequest" "RTFileRequest" "RTLockWindow" "RTNextPathEntry" 
	"RTR" "RTRequest" "RTRevision" "RTS" "RTUnlockWindow" 
	"RTVersion" "RastPort" "RawKey" "RawStatus" "ReMap" 
	"Read" "ReadChunky" "ReadFile" "ReadMem" "ReadSector" 
	"ReadSerial" "ReadSerialMem" "ReadSerialString" "Reboot" "Record" 
	"RectsHit" "Red" "RedoColSplit" "Redraw" "RedrawBox" 
	"RedrawPage" "ReduceX2" "RelMouse" "RemICRVector_a" "RemICRVector_b" 
	"RemoveFNS" "Rename" "RenderPoly" "RenderToBitmap" "RenderToChunky" 
	"Repeat" "Repeats" "Replace$" "ReplyRexxMsg" "ReqColours" 
	"ReqFileLoc" "ReqFileRequest" "ReqFileRequest$" "ReqFontSize" "ReqOutput" 
	"Req_Base" "Request" "Reserve" "ResetList" "ResetString" 
	"ResetTimer" "Restore" "Return" "Rex_Base" "RexxError" 
	"RexxEvent" "RexxSysBase" "RexxsysBase" "Right$" "Rnd" 
	"Rotate" "Rrandomize" "Rrnd" "Run" "Runerrsoff" 
	"Runerrson" "SBCD" "SBlit" "SBlitMode" "SColl" 
	"SHARED" "SMouseX" "SMouseY" "SPACE$" "STOP" 
	"SUB" "SUBA" "SUBI" "SUBQ" "SUBX" 
	"SWAP" "SafeToBlit" "SaveBank" "SaveBitmap" "SaveCMAP" 
	"SaveChunky" "SaveIncData" "SavePalette" "SaveScreen" "SaveShape" 
	"SaveShapes" "SaveSprites" "SaveTape" "Scale" "ScaleChunkyX" 
	"ScaleChunkyY" "Scc" "Screen" "ScreenHeight" "ScreenPens" 
	"ScreenTags" "ScreenWidth" "ScreensBitMap" "Scroll" "SearchBegin" 
	"SearchEnd" "SearchMem" "SearchMemFound" "SearchString" "Secs" 
	"Select" "SelectBox" "SelectMode" "SendRexxCommand" "SerialEvent" 
	"SetBLWait" "SetBPLCON0" "SetBits" "SetBox" "SetBoxColor" 
	"SetBoxString" "SetBoxTitle" "SetColl" "SetCollHi" "SetCollOdd" 
	"SetCopyBuffer" "SetCxStatus" "SetCycle" "SetEnv" "SetErr" 
	"SetEventFilter" "SetFileComment" "SetGadgetStatus" "SetHProp" "SetHotKey" 
	"SetICR_a" "SetICR_b" "SetIconHit" "SetIconType" "SetInt" 
	"SetLocal" "SetMedMask" "SetMedVolume" "SetMenu" "SetPagePens" 
	"SetPeriod" "SetSerialBuffer" "SetSerialLens" "SetSerialParams" "SetStatus" 
	"SetString" "SetTextGadget" "SetToolValue" "SetVProp" "SetVoice" 
	"SetWildString" "SetZone" "SetZoneMode" "SetupLESDebug" "Sgn" 
	...
	"SoundData" "Space$" "Speak" "SpotBox" "SpriteMode" 
	"SpritesHit" "Sqr" "Start" "StartMedModule" "StartTracker" 
	"Statement" "Stencil" "Stop" "StopCycle" "StopMed" 
	"StopModule" "StopTracker" "Str$" "StrToFls" "String$" 
	"StringGadget" "StringSort" "StringSortDir" "StringSortItem" "StringText$" 
	"StripLead$" "StripTrail$" "SubHit" "SubIDCMP" "SubItem" 
	"SubItemOff" "SwapBank" "SysJsr" "SystemDate" "TAS" 
	"TRAP" "TRAPV" "TST" "Tan" "TapeTrap" 
	"TaskName$" "TextGadget" "TextRequest" "TextTimeout" "Then" 
	"Ticks" "Timer" "To" "Toggle" "ToggleBox" 
	"TokeJsr" "TrackerVolume" "Translate$" "True" "Type" 
	"UCase$" "UNLK" "USED" "USEPATH" "UStr$" 
	"UnBuffer" "UnLeft$" "UnPackPBM" "UnQueue" "UnRight$" 
	"UnSetEnv" "UnSetLocal" "UnpackIFF" "UnpackPCF" "Until" 
	"Use" "UseCatalog" "UseZoneTable" "Used" "VPos" 
	"VPropBody" "VPropPot" "VWait" "VWaitPos" "Val" 
	"ViewPort" "VoiceLoc" "Volume" "Vpos" "VwaitPos" 
	"WBDepth" "WBExtViewMode" "WBHeight" "WBStartup" "WBViewMode" 
	"WBWidth" "WBlit" "WBox" "WCircle" "WCls" 
	"WColour" "WCursX" "WCursY" "WEllipse" "WJam" 
	"WLeftOff" "WLine" "WLocate" "WMouseX" "WMouseY" 
	"WMove" "WPlot" "WPointer" "WPrintScroll" "WScroll" 
	"WSize" "WTitle" "WTopOff" "Wait" "WaitBlitter" 
	"WaitCommodity" "WaitEvent" "WaitFor" "WaitTrackerEvent" "WbToScreen" 
	"WeekDay" "Wend" "While" "Window" "WindowFont" 
	"WindowHeight" "WindowInput" "WindowOutput" "WindowTags" "WindowWidth" 
	"WindowX" "WindowY" "Wline" "WriteBoot" "WriteChunky" 
	"WriteFile" "WriteMem" "WriteSector" "WriteSerial" "WriteSerialMem" 
	"WriteSerialString" "XBDecodeSound" "XBDiskBuffer" "XBDiskPlay" "XBFilter" 
	"XBInitSound" "XBLoadSound" "XBLoopSound" "XBPeekSound" "XBSetPeriod" 
	"XBSound" "XBSoundData" "XBVolume" "XFlip" "XINCLUDE" 
	"XOR" "XStatus" "Xor" "YFlip" "Years" 
	"Zone" "ZoneInit" "ZoneMode" "ZoneTable" "ZoneTableNumber" 
	"ZoneTableSize" "ZoneTest" "ZoomX2" "ZoomX4" "ZoomX8" 
	"ZoomXY" "cr_vbr"))
